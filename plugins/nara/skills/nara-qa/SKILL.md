---
name: nara-qa
description: "Phase 7 of the Nara pipeline — edge case hunt (bmad-review-edge-case-hunter), Maestro E2E test generation, and QA checklist from all story acceptance criteria. Requires all stories Done from /nara-dev."
---
...
### Step 2 — Edge case hunt

Invoke the `bmad-review-edge-case-hunter` skill with the following inputs:
...
Using the Linear MCP `save_issue` tool, update all feature stories to status `In QA`.
